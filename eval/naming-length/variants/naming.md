...
| Bare HTTP status code (`200`, `404`, `409`) | Leaks the HTTP layer; the same behaviour at gRPC would be unnamable | The outcome verb: `accepts`, `rejects duplicate id`, `reports missing` |
